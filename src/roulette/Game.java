...
public class Game {
    ...
    public void play (Gambler player) {
        ...
        Bet betty = myPossibleBets[whichBet];
        String betChoice = placeBet(betty);

        System.out.print("Spinning ...");
        myWheel.spin();
        System.out.println(String.format("Dropped into %s %d", myWheel.getColor(), myWheel.getNumber()));
        if (betIsMade(betty, betChoice)) {
    ...
    private boolean betIsMade (Bet myBet, String betChoice) {
    	return myBet.betResults(myWheel, betChoice);
    }
}
