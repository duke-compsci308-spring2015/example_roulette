...
public class Game {
    ...
    public void play (Gambler player) {
        ...
        if (getBetResult(whichBet, betChoice)) {
    ...
    private Object[] getResults(){
    	return new Object[]{myWheel.getColor(), myWheel.getNumber()}; 
    }
     ...
     */
    private boolean getBetResult (int whichBet, String betChoice) {
    	return myPossibleBets[whichBet].betIsMade(betChoice, getResults());
    }
}
