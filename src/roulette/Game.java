...
public class Game {
    ...
    public void play (Gambler player) {
        ...
        myCurrentBet = myPossibleBets[promptForBet()];
        String betChoice = placeBet();
    ...
    private boolean betIsMade (String betChoice) {
       return myCurrentBet.compareBet(myWheel, betChoice);
    }
}
