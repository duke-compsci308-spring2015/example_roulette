...
public class Game {
    ...
    public void play (Gambler player) {
        ...
        Bet myBet = myPossibleBets[promptForBet()];
        String placedBet = myBet.placeBet();
        System.out.print("Spinning ... ");
        myWheel.spin();
        System.out.println(String.format("Dropped into %s %d", myWheel.getColor(), myWheel.getNumber()));
        amount *= myBet.returnWinningsAndPrintResults(myWheel,placedBet);
